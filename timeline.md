...
==== Not included in the 2026 roadmap


Q4 2026
- [ ] sharding: building coalitions that are larger than what is allowed by standardness
...
Production Deployment due Q3 2026.

### Self-Analysis Privacy Tools / Clustering Analysis Suite  (y2)


An open-source blockchain analysis tool designed to evaluate and enhance the privacy features of Bitcoin transactions. By providing accessible and transparent chain analysis capabilities, the project aims to empower developers, researchers, and the broader Bitcoin community to understand, test, and validate the privacy effectiveness of tools like PayJoin, CoinJoin, and other privacy-preserving technologies. The platform will include heuristics for clustering addresses, fingerprinting wallets, transaction flow tracking, while ensuring developer friendly integration with existing privacy projects.


Bitcoin’s long-term viability as a secure, censorship-resistant money depends on robust privacy tools to protect user anonymity. However, without transparent and open methods to evaluate these tools, it is difficult to measure their effectiveness against private chain analysis. Self-analysis fills this gap by providing:


- A standardized framework for analyzing transaction privacy.
- Enhanced transparency in evaluating the resilience of privacy tools against chain analysis techniques.
- Tools for developers and researchers to iterate and improve on Bitcoin’s privacy features.


Additionally, only private institutions mainly, chainanalysis, have the tools to deanonymize Bitcoin's users today. Users have no means to analyze the privacy of their wallet setup. Our self-analysis tools aim to provide a suite of tools to analyze the privacy of a user's setup in a private and transparent manner.


In short, it provides two main objectives:


- To be made obsolete by future privacy enhancing technologies.
- To provide a suite of tools for the community to analyze the privacy of their wallet setups.


By equipping the community with these resources, self-analysis strengthens the overall defense against privacy erosion.


The first phase of this is to release coin selection algorithms inside the `payjoin` library, one of which already exists to avoid Unnecessary Input Heuristic. A standalone library is due Q4 2026. Phase 1 is likely to begin Q2 2025.


#### Phase 1: Research and Planning (Month 1-4)

- [ ] Identify key heuristics used in chain analysis
  - [ ] including clustering
  - [ ] transaction path tracing (Istvan's model)
  - [ ] wallet fingerprinting
- [ ]Identify off-chain data sources including leaked data from exchanges, wallet providers, and other sources that current chain analysis firms use to deanonymize users
- [ ] Setup cloud infrastructure for indexed data storage and analysis tools (Armin collects unconfirmed TXs for months, RBF data [ ] WHEN does this become accessible?)
- [x] Research techniques employed by chain analysis firms and identify countermeasures [we kind of did this with the research calls' study club]
  - [x] archive https://github.com/orgs/payjoin/discussions/categories/study-club
- Design project architecture, including modular analysis tools and integration points [I think this is emergent behavior]


#### Phase 2: Development of Core Framework (Month 5-8)


- [ ] Index and collect data from a subset of the Bitcoin blockchain
  - [ ]
- [ ] Implement basic clustering heuristics and transaction graph indexing
  - [ ] coinbase
  - [ ] common input
  - [ ] uih
- [x] Implement a library for identifying wallet fingerprints
- [ ] Analyze exchange and other wallet provider spend behavior
- [ ] Write user documentation and integration guides
- [ ] (stretch goal) Integrate off-chain data sources


#### Phase 3: Developing The Interface (Month 9-15)

- [ ] Implement statistical tools to measure the effectiveness of privacy-preserving technologies
- [ ] Develop a benchmarking tool for comparing privacy methods
  - [ ] coalition formation requires this
- [ ] Develop a developer/application interface for analyzing wallet privacy heuristics
  - [ ] kind of like the methods `try_preserving_privacy` calls
- [ ]  Develop case studies showcasing real-world application of the tool


#### Phase 4: Community Engagement and Expansion (Month 16-20)

- Solicit feedback from privacy researchers and Bitcoin developers
  - [ ] bitcoin research week
  - [ ] ongoing monthly cadence
  - [ ] conferences
  - [ ] journals for published papers
- Expand tool capabilities based on community input
- Prepare for ongoing maintenance and updates
- Create a support and contribution framework for future iterations
